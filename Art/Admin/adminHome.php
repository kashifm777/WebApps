					...
					<ul class="user-nav">
						<li class="dropdown user-icon">
							<a class="dropdown-toggle" data-toggle="dropdown" href="#">
								<span>Hi <?php echo $_SESSION['uname']; ?> </span> <span class="glyphicon glyphicon-user"></span>  <span class="glyphicon glyphicon-triangle-bottom"></span>
							</a>
			...
			<div class="row center-container">
				...
				<div class="col-md-10">
					...
					<div id="about" class="switchgroup dashboard">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<!-- About us content  -->
								<div class="panel panel-default social-links">
									<div class="panel-heading"><h4>About us Content</h4></div>
									<div class="panel-body">
										<?php	
										...
										<form class="form-inline" method="post">
											<div class="form-group">
												<textarea class="form-control" rows="10" cols="100" name="info" id="myInfo">
													<?php 
														echo $aboutcontent['page_desc'];
													?>
												</textarea>
											</div> <br/>
											<span class="text-success" style="padding-left:10px"><?php echo $about_msg; ?></span><br/>
											<div class="form-group">
					...
					<div id="reach_us" class="switchgroup dashboard">
						<div class="panel panel-default">
							<div class="panel-heading"><h3>Reach us</h3></div>
							<div class="panel-body">
